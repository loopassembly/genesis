 ...
 */
export function get({ issuer, with: resource, proofs, audience }: import('./types.js').InvocationConfig, link: import('multiformats/link').UnknownLink, options?: import("./types.js").RequestOptions | undefined): Promise<import('./types.js').StoreGetSuccess>;
/**
