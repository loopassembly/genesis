...
export function computeChecksum(segment: API.Segment): API.Checksum<API.Segment, typeof ChecksumSize>;
export function withChecksum(segment: API.Segment): API.SegmentInfo;
...
export function toBytes({ root, size, offset, checksum }: (API.Segment & {
    checksum?: undefined;
}) | API.SegmentInfo): API.ByteView<API.SegmentInfo, API.RAW_CODE>;
