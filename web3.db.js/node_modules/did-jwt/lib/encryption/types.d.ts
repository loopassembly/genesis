...
export type KeyWrapper = {
     ...
     */
    from: (kek: Uint8Array) => {
        wrap: (cek: Uint8Array, options?: any) => Promise<WrappingResult>;
    };
    alg: 'A256KW' | 'XC20PKW' | string;
};
export type KekCreator = {
    createKek(recipientPublicKey: Uint8Array, senderSecret: Uint8Array | ECDH | undefined, alg: string, apu: string | undefined, apv: string | undefined, ephemeralKeyPair: EphemeralKeyPair | undefined): Promise<{
        epk: JsonWebKey;
        kek: Uint8Array;
    }>;
